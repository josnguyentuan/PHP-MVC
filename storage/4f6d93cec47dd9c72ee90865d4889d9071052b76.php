        ...
        <div class="col-6 offset-3">
            <form action="" method="post">
                <div class="form-group">
                    ...
                    <input type="text" name="name_cate" value="<?php echo e($cate->name_cate); ?>" class="form-control">
                </div>
...
<?php echo $__env->make('layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /opt/lampp/htdocs/PHP2/mvc/app/views/admin/category/edit-form.blade.php ENDPATH**/ ?>